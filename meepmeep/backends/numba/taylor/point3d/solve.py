...
@njit(fastmath=True)
def solve3d(tk: float, p: float, a: float, i: float, e: float, w: float, lan: float = 0.0) -> NDArray:
    """ Calculate the Taylor expansion for the (x, y, z) position around a given knot time relative to the transit centre.
