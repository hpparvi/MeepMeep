...
from meepmeep.backends.numba.taylor.position2dd import pos_d, sep_d
...
class TestT0Derivative:
    ...
    def test_sep_d_and_pos_d_dt0_finite_difference(self, eccentric_orbit, time):
        ...
        _, _, dpx, dpy = pos_d(time, t0, p, c, dc)
        pxp, pyp, _, _ = pos_d(time, t0 + h, p, c, dc)
        pxm, pym, _, _ = pos_d(time, t0 - h, p, c, dc)
